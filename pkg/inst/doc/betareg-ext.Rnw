...
similar as indicated by the comparsion of the two red lines. By
...
reliable inference. Recursive partitiong methods and finite mixture
...
available in package \pkg{betareg}. Thses functions reuse
...
the bias corrected / reducted versions of the ML estimates. For
