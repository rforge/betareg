...
gyBC <- betareg(yield ~ batch + temp, data = GasolineYield, link.phi = "identity",
                type = "BC")
gyBR <- betareg(yield ~ batch + temp, data = GasolineYield, link.phi = "identity",
                type = "BR")
...
gyBClog <- betareg(yield ~ batch + temp, data = GasolineYield, link.phi = "log",
                   type = "BC")
gyBRlog <- betareg(yield ~ batch + temp, data = GasolineYield, link.phi = "log",
                   type = "BR")
